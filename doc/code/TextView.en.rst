...
.. sidebar:: Verification
   ...
   `Test code for example <https://github.com/SolidWallOfCode/libswoc/blob/1.2.21/unit_tests/ex_TextView.cc#L67>`__.
...
.. sidebar:: Verification
   ...
   `Test code for example <https://github.com/SolidWallOfCode/libswoc/blob/1.2.21/unit_tests/ex_TextView.cc#L74>`__.
...
.. sidebar:: Verification
   ...
   `Test code for example <https://github.com/SolidWallOfCode/libswoc/blob/1.2.21/unit_tests/ex_TextView.cc#L90>`__.
