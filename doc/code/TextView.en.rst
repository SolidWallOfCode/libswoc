...
.. sidebar:: Verification
   ...
   `Test code for example <https://github.com/SolidWallOfCode/libswoc/blob/1.5.0/unit_tests/ex_TextView.cc#L73>`__.
...
.. sidebar:: Verification
   ...
   `Test code for example <https://github.com/SolidWallOfCode/libswoc/blob/1.5.0/unit_tests/ex_TextView.cc#L90>`__.
